...
import { categories, facilities, types } from '../data.js'
import variables from "../styles/variables.scss";
import { AddCircleOutline, RemoveCircleOutline } from '@mui/icons-material'
import { IoIosImages } from "react-icons/io"

import "../styles/create-listing.scss" 
...
const CreateListing = () => {
    ...
    const handlePost = async(e) => {
        ...
        try{
            ...
            const res = await fetch("http://localhost:4000/properties/create", {
                method: "POST",
                body: listingForm
            })
            if(res.ok){
            ...
            <form onSubmit={handlePost}>
                <div className="create-listing_step1">
                    ...
                    <div className="half">
                        <div className="location">
                            ...
                            <input type="text" placeholder='Apt, Suite, etc. (if applicable)' value={formLocation.aptSuite} onChange={handleChangeLocation} name='aptSuite' required />
                        </div>
                        <div className="location">
                            <p>City</p>
                            <input type="text" placeholder='City' value={formLocation.city} onChange={handleChangeLocation} name='city' required />
                        </div>
                    </div>
                    <div className="half">
                        <div className="location">
                            <p>Province</p>
                            <input type="text" placeholder='Province' value={formLocation.province} onChange={handleChangeLocation} name='province' required />
                        </div>
                        <div className="location">
                            <p>Country</p>
                            <input type="text" placeholder='Country' value={formLocation.country} onChange={handleChangeLocation} name='country' required />
                        </div>
                    </div>
                ...
                <div className="create-listing_step2">
                    ...
                    <div className="description">
                        ...
                        <div className="description_area">
                            <p>Description</p>
                            <textarea name="description" placeholder='Description' value={formDescription.description} onChange={handleChangeDescription} required></textarea>
                        </div>
                        <div className="description_area">
                            <p>Highlight</p>
